  ...
  return (
    <div className="min-h-screen bg-white font-barlow">
      ...
      <section className="relative bg-[#0A1628] overflow-hidden min-h-[88vh] flex items-center">
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(105deg, rgba(10,22,40,0.95) 0%, rgba(10,22,40,0.9) 35%, rgba(10,22,40,0.3) 50%, rgba(10,22,40,0.05) 65%, transparent 80%)" }} />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                stars: false,
                href: "https://www.amazon.com/Zippy-Brain-Inc-Earth-Carol/dp/B00BQ0ZQ70",
                imgFit: "object-cover",
              },
            ].map((book) => (
